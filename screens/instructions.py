...
def mostrar_instrucciones(screen, WIDTH, HEIGHT, font_title, font_button, event, mouse_pos):
    ...
    como_jugar = [
        ...
        "7. Presiona '?' para consultar el Repaso",
        "   desde la seleccion de metodo",
        "   (cuesta 1 vida, el tiempo sigue).",
        "8. Avanza por las 3 lineas del metro.",
    ]

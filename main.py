...
def main():
    ...
    while True:
        ...
        if current_screen == "inicio":
            ...
            btn_inst.center = (WIDTH // 2, HEIGHT // 2 + 322)
            ...
            draw_text("Instrucciones", font_button, (180, 180, 180), screen, WIDTH // 2, HEIGHT // 2 + 322)

            btn_repaso = pygame.Rect(0, 0, BTN_W, BTN_H)
            btn_repaso.center  = (WIDTH // 2, HEIGHT // 2 + 394)
            ...
            draw_text("Repaso", font_button, (180, 180, 180), screen, WIDTH // 2, HEIGHT // 2 + 394)
